...
const Info = ({ singleProduct }) => {
    ...
    const discountPrice = originalPrice - (originalPrice * discountedPercentage) / 100;
          ...
          <form className="variations-form">
              <div className="variations">
                  ...
                  <div className="cart-button">
                      ...
                      <button className="btn btn-lg btn-primary" id="add-to-cart" type="button" disabled={filteredCard}
                      onClick={() => addToCart({
                        ...singleProduct, price: discountPrice, quantity: parseInt(quantityRef.current.value),
                      })}>Add to cart</button>
                  </div>
